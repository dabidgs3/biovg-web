...
SECRET_KEY = 'wytw)(0610_jl&)&nlgjev!^&h7&be!=2zg9qn$9b)%yov5*v#'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['django-env.uvzeshzmdg.eu-central-1.elasticbeanstalk.com','127.0.0.1']
